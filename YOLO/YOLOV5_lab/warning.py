...
logo_warning = cv2.imread("./logo/warning.png")
h_logo_warning, w_logo_warning, _ = logo_warning.shape
logo_stop = cv2.imread("./logo/stop.png")
h_logo_stop, w_logo_stop, _ = logo_stop.shape
logo_flag = cv2.imread("./logo/warningflag.png")
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if x < 640:
                            ...
                            # 危险物检测报警模块————警示标志
                            if (names[c] == "warning") and (y < 300) and (x < 300):
                                # logosize = 200
                                # global logo_flag
